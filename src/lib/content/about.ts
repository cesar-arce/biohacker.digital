...
const en: AboutContent = {
  ...
  bio: [
    ...
    'That discipline carried him into the skies. As a military pilot, he mastered celestial navigation — orienting himself by the same stars that had guided him as a child — and trained in jungle, sea, and desert survival, and elite parachuting operations. Altitude stripped away the noise of modern life. What remained, always, were the same subtle patterns and unseen forces he had first sensed in those early mountain camps.',
...
const fr: AboutContent = {
  ...
  authorRole: 'Auteur · Narrateur · Pilote · Explorateur',
  bio: [
    ...
    'Cette discipline l\'a porté vers les cieux. En tant que pilote militaire, il a maîtrisé la navigation céleste — s\'orientant par les mêmes étoiles qui l\'avaient guidé enfant — et s\'est formé à la survie en jungle, en mer et dans le désert, ainsi qu\'aux opérations de parachutisme d\'élite. L\'altitude effaçait le bruit de la vie moderne. Ce qui demeurait, toujours, c\'étaient les mêmes schémas subtils et forces invisibles qu\'il avait pressentis pour la première fois dans ces premiers camps de montagne.',

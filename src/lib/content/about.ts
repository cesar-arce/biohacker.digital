...
const en: AboutContent = {
  ...
  bio: [
    'The author\'s life has been a kaleidoscope of discovery — bridging the worlds of science, survival, and subtle energy.',
    'His journey began at the age of six in the World Organization of the Scout Movement (WOSM), where — amid treks, camps, and star-filled nights — he learned survival skills, land navigation, astronomical orientation, and the invisible language of nature whispered through its most subtle signs.',
    'This early fascination evolved into a distinguished military career as a fighter pilot, with advanced training in celestial navigation, jungle, sea, and desert survival, and elite parachuting operations. Time and again, these experiences brought him face to face with the natural patterns and invisible forces that had captivated him since childhood.',
    'Over the past three decades, his path turned inward, toward the ancient science of radiesthesia. Guided by curiosity and a desire to explore what lies beyond the five senses, he immersed himself in detecting subtle energies and invisible patterns that affect health and well-being. His search also led through initiatic traditions, esoteric schools, and philosophical lodges, where he studied alchemical methods that deepened his scientific research with spiritual insight.',
  ],
...
const es: AboutContent = {
  ...
  bio: [
    'La vida del autor ha sido un caleidoscopio de descubrimientos — tendiendo puentes entre los mundos de la ciencia, la supervivencia y la energía sutil.',
    'Su viaje comenzó a los seis años en la Organización Mundial del Movimiento Scout (WOSM), donde — entre caminatas, campamentos y noches estrelladas — aprendió habilidades de supervivencia, navegación terrestre, orientación astronómica y el lenguaje invisible de la naturaleza susurrado a través de sus señales más sutiles.',
    'Esta fascinación temprana evolucionó hacia una distinguida carrera militar como piloto de combate, con entrenamiento avanzado en navegación celeste, supervivencia en jungla, mar y desierto, y operaciones de paracaidismo de élite. Una y otra vez, estas experiencias lo pusieron cara a cara con los patrones naturales y las fuerzas invisibles que lo habían cautivado desde la infancia.',
    'Durante las últimas tres décadas, su camino se volvió hacia adentro, hacia la antigua ciencia de la radiestesia. Guiado por la curiosidad y el deseo de explorar lo que está más allá de los cinco sentidos, se sumergió en la detección de energías sutiles y patrones invisibles que afectan la salud y el bienestar. Su búsqueda también lo llevó por tradiciones iniciáticas, escuelas esotéricas y logias filosóficas, donde estudió métodos alquímicos que profundizaron su investigación científica con perspectiva espiritual.',
  ],
...
const fr: AboutContent = {
  ...
  bio: [
    'La vie de l\'auteur a été un kaléidoscope de découvertes — faisant le pont entre les mondes de la science, de la survie et de l\'énergie subtile.',
    'Son parcours a commencé à l\'âge de six ans au sein de l\'Organisation Mondiale du Mouvement Scout (WOSM), où — au fil de randonnées, de camps et de nuits étoilées — il a appris des compétences de survie, la navigation terrestre, l\'orientation astronomique et le langage invisible de la nature murmuré à travers ses signes les plus subtils.',
    'Cette fascination précoce a évolué vers une brillante carrière militaire comme pilote de chasse, avec une formation avancée en navigation céleste, survie en jungle, en mer et dans le désert, et opérations de parachutisme d\'élite. À maintes reprises, ces expériences l\'ont mis face à face avec les schémas naturels et les forces invisibles qui le captivaient depuis l\'enfance.',
    'Au cours des trois dernières décennies, son chemin s\'est tourné vers l\'intérieur, vers l\'ancienne science de la radiesthésie. Guidé par la curiosité et le désir d\'explorer ce qui se trouve au-delà des cinq sens, il s\'est immergé dans la détection des énergies subtiles et des schémas invisibles qui affectent la santé et le bien-être. Sa quête l\'a également mené à travers des traditions initiatiques, des écoles ésotériques et des loges philosophiques, où il a étudié des méthodes alchimiques qui ont approfondi sa recherche scientifique avec une perspective spirituelle.',
  ],
